...
import { ChatBoxData } from '../../Data/AppData/ChatBoxData';
             ...
             <>
                <div className="chat-header d-flex justify-content-between align-items-center border-bottom pb-3">
                    <div className="d-flex align-items-center">
                        <Link to={process.env.PUBLIC_URL + "/"} className="d-block d-xxl-none"><i className="icofont-arrow-left fs-4"></i></Link>
                        <a href="#!" title="">
                    ...
                    <div className="d-flex">
                        ...
                        <div className="nav-item list-inline-item d-block d-xl-none py-2 px-3">
                            <Dropdown>
